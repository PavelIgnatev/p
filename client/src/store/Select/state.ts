...
export const ADDRESS = [
  ...
  { value: "mgr.miranda85@gmail.com,pocarrlatina@gmail.com", label: "Latina" },
...
export const SHORT_NETWORKS_FOR_USER = [
  { value: "", label: "all" },
  { value: "PS.eu", label: "PS.eu" },
  { value: "IP", label: "IP" },
  { value: "Chico", label: "Chico" },
...
const SAVED_EDITABLE_TOURNAMENTS_SETTINGS: tournamentsSettingsProps | null = JSON.parse(localStorage.getItem("curState") || "null")

export const DEFAULT_EDITABLE_TOURNAMENTS_SETTINGS: tournamentsSettingsProps = 
SAVED_EDITABLE_TOURNAMENTS_SETTINGS
||
{
  network: null,
  time: TIMERANGE[1],
