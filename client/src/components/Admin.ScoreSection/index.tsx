...
import { getScoresRequest } from "../../store/Score";
...
import { ScoresSectionScores } from "./__Score";
...
export const ScoreSection = () => {
  ...
  return (
    <section className={b()}>
      <span className={b("title")}>Rules for Score:</span>
      <LevelBlocks
        ...
        <>
          {!isAllLevels ? (
            <h2 className={b("subtitle")}>
              Score for <strong>{selectedLevel} level</strong>
            </h2>
          ) : (
            <h2 className={b("subtitle")}>
              Score for <strong>all level</strong>
            </h2>
          )}
